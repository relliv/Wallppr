...
//
//    using YuTub.Models.Youtube.Json;
//
...
namespace Wallppr.ReleaseCheck
{
    ...
    public partial class Release
    {
        public static List<Release> FromJson(string json) => JsonConvert.DeserializeObject<List<Release>>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Release> self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
